...
var Settings = React.createClass({
    ...
    render: function() {
        ...
        return (
            ...
            <Geosuggest ref = "adressOfRestaurant" defaultValue = {this.props.mainState.restaurant.adress} onChangeAction = {this.props.actions.restaurantAdressChanged} className = "col-md-8 col-md-offset-2" type="text" id = "adress" placeholder = "Adress" />
